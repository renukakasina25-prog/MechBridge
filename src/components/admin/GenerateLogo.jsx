  ...
  const generateLogo = async () => {
    ...
    try {
      const result = await client.integrations.Core.GenerateImage({
        ...
        existing_image_urls: ["https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/mechbridge-prod/public/68bd4d604890101c87a5b6b7/6dda5dcbf_ChatGPTImageJan2202611_11_30PM.png"]
      });
